...
-   Column auto-completion andexpansion into parent forms, sub-forms, reference forms, etc.
...
remotes::install_github("bedatadriven/activityinfo-R", build_vignettes = TRUE)
